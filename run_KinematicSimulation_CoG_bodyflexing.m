...
for cycle=1:cycles % how many cycles of gait
    ...
    for legs=[2,1,4,3] % leg sequence
        ...
        for i=1:npoints-1 % going through trajectory points
            ...
            jc1 = Jacobian_leg1_flex(qr(1:2, count), 1, B(:, count), b, 0.0, L, r);
            jc2 = Jacobian_leg2_flex(qr(3:4, count), 1, B(:, count), b, 1.0, L, r);
            jc3 = Jacobian_leg3_flex(qr(5:6, count), 1, B(:, count), b, 0.0, L, r);
            jc4 = Jacobian_leg4_flex(qr(7:8, count), 1, B(:, count), b, 1.0, L, r);
            ...
            Jcog = Jacobian_cog_flex(qr(1:8), 1, B(:, count), b, 1.0, L, r);
